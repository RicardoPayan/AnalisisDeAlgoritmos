...
int main() {
    ...
    std::ofstream prom_times("merge_prom_times.txt", std::ios::app);
    ...
    std::ofstream best_times("merge_best_times.txt", std::ios::app);
    ...
    std::ofstream worst_times("merge_worst_times.txt", std::ios::app);
